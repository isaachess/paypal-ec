 ...
 * @param {Function} callback Function to get called when done.
 */
PayPalEC.prototype.do_reauthorization = function ( params, callback ){
  this.nvpreq.execute( 'DoReauthorization', params, callback );
};
 ...
 * @param {Function} callback Function to get called when done.
 */
PayPalEC.prototype.manage_rpp_status = function ( params, callback ){
  this.nvpreq.execute( 'ManageRecurringPaymentsProfileStatus', params, callback );
};
