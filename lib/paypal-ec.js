 ...
 * @requires nvprequest
 * @param {Object} cred Contain the credential requred to make an API call
...
/**
 * Make an `SetExpressCheckout` API call to PayPal.
 * @public
 * @this {PayPalEC}
...
/**
 * Make an `GetExpressCheckoutDetails` API call to PayPal.
 * @public
 * @this {PayPalEC}
...
/**
 * Make an `DoExpressCheckoutPayment` API call to PayPal.
 * @public
 * @this {PayPalEC}
